...
--
-- Servidor: localhost
-- Tiempo de generación: 23-02-2024 a las 17:05:35
...
(28, 'area desde frontend', 'esta es la descripcion desde frontend', '2024-02-05 00:14:16', '2024-02-05 00:14:16'),
(29, 'area26', 'area26 description', '2024-02-05 08:14:45', '2024-02-05 08:14:45'),
(30, 'area nueva xddd', 'esta es una descripción rápida', '2024-02-05 08:36:06', '2024-02-05 11:45:06'),
(31, 'area nueva xd2', 'descripcion 2 xd', '2024-02-05 08:36:43', '2024-02-05 08:36:43'),
(32, 'area nueva xd3', 'description 3', '2024-02-05 08:38:59', '2024-02-05 08:38:59'),
(33, 'area nueva xd4', 'la mejor area', '2024-02-05 08:41:26', '2024-02-05 11:17:30'),
(34, 'area nuevo 2024', 'esta es una area nueva', '2024-02-05 11:11:25', '2024-02-05 11:11:25'),
(35, 'area 2025', 'esta area esta muy buena', '2024-02-05 11:18:46', '2024-02-05 11:18:46'),
(36, 'area 2026', 'ya es el mundial', '2024-02-05 11:19:59', '2024-02-05 11:19:59');
...
(54, 'C-7776', 'Jose', 'Chirinos', 1, '2024-02-06 04:25:16', '2024-02-06 04:26:22');
...
(54, 'C-67D', 'Red Fusion 2', 'the new color', '2024-02-05 15:11:04', '2024-02-05 15:12:05');
...
INSERT INTO `occupation` (`id`, `name`, `id_turn`, `created_at`, `updated_at`) VALUES
(1, 'Operador de Maquinaria', 1, '2024-02-06 11:15:43', '2024-02-15 23:28:50'),
(2, 'Administrador de Inventarios', 1, '2024-02-06 11:15:43', '2024-02-06 11:15:43'),
(3, 'Despachador', 1, '2024-02-06 11:15:43', '2024-02-06 11:15:43'),
(4, 'Ocupación de prueba edit', 2, '2024-02-06 11:58:35', '2024-02-06 11:59:36'),
(5, 'Sistemas', 4, '2024-02-15 11:34:04', '2024-02-15 11:34:04'),
(6, 'Contaduria', 2, '2024-02-15 11:37:24', '2024-02-15 11:37:24'),
(33, 'Administración', 1, '2024-02-16 01:02:10', '2024-02-16 01:02:10'),
(34, 'Secretaria 1', 1, '2024-02-16 01:02:31', '2024-02-16 01:02:31'),
(35, 'Secretaria 2', 1, '2024-02-16 01:02:41', '2024-02-16 01:02:41'),
(36, 'Ventas Mañana', 1, '2024-02-16 01:03:00', '2024-02-16 01:03:00'),
(37, 'Ventas Tarde', 2, '2024-02-16 01:03:07', '2024-02-16 01:03:07');
...
CREATE TABLE `operator` (
  `id` int(11) NOT NULL,
  `cod_operator` varchar(20) NOT NULL,
...
INSERT INTO `operator` (`id`, `cod_operator`, `first_name`, `last_name`, `cellphone`, `id_occupation`, `created_at`, `updated_at`) VALUES
(1, 'O-1123', 'Jorge', 'Antelo Mendez', '79458621', 2, '2024-02-06 11:16:26', '2024-02-06 11:16:26'),
(2, 'O-5253', 'Alex Misael', 'Ramos', '79458621', 5, '2024-02-06 23:03:10', '2024-02-16 00:44:40'),
(3, 'O-123', 'Jose', 'Chirinos', '79413052', 5, '2024-02-16 01:00:57', '2024-02-16 01:00:57');
...
CREATE TABLE `product` (
  ...
  `name` varchar(150) NOT NULL,
  `weight_less` double NOT NULL,
  `weight_total` double NOT NULL,
...
INSERT INTO `product` (`id`, `lote`, `name`, `weight_less`, `weight_total`, `observation`, `id_area`, `id_color`, `id_title`, `created_at`, `updated_at`) VALUES
(1, '2555', 'Producción con material chino', 1.5, 50, 'Se tiene un sobrante', 28, 54, 22, '2024-02-06 11:18:29', '2024-02-23 01:25:24'),
(2, '8374', 'Algodón Blanco', 0.5, 52, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:47', '2024-02-06 11:25:47'),
(3, '5910', 'Lino Azul', 0.7, 50.8, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:47', '2024-02-06 11:25:47'),
(4, '2468', 'Seda Roja', 0.3, 53.2, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:48', '2024-02-06 11:25:48'),
(5, '7032', 'Algodón Negro', 0.6, 51.9, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:48', '2024-02-06 11:25:48'),
(6, '4189', 'Lino Verde', 0.8, 50.7, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:48', '2024-02-06 11:25:48'),
(7, '1257', 'Seda Amarilla', 0.2, 53.3, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:48', '2024-02-06 11:25:48'),
(8, '9643', 'Algodón Gris', 0.4, 52.4, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:48', '2024-02-06 11:25:48'),
(9, '3701', 'Lino Morado', 0.9, 50.6, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:48', '2024-02-06 11:25:48'),
(10, '5826', 'Seda Naranja', 0.1, 53.4, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:48', '2024-02-06 11:25:48'),
(11, '7398', 'Algodón Azul', 0.5, 52, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:48', '2024-02-06 11:25:48'),
(12, '2035', 'Lino Amarillo', 0.7, 50.8, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:48', '2024-02-06 11:25:48'),
(13, '8765', 'Seda Verde', 0.3, 53.2, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:48', '2024-02-06 11:25:48'),
(14, '5491', 'Algodón Morado', 0.6, 51.9, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:48', '2024-02-06 11:25:48'),
(15, '6823', 'Lino Naranja', 0.8, 50.7, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:48', '2024-02-06 11:25:48'),
(16, '3174', 'Seda Roja', 0.2, 53.3, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:48', '2024-02-06 11:25:48'),
(17, '8904', 'Algodón Blanco', 0.4, 52.4, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:48', '2024-02-06 11:25:48'),
(18, '4261', 'Lino Azul', 0.9, 50.6, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:48', '2024-02-06 11:25:48'),
(19, '1059', 'Seda Verde', 0.1, 53.4, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:48', '2024-02-06 11:25:48'),
(20, '7532', 'Algodón Negro', 0.5, 52, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:48', '2024-02-06 11:25:48'),
(21, '6189', 'Lino Rojo', 0.7, 50.8, 'se obtuvo kilos adicionales', 2, 54, 22, '2024-02-06 11:25:48', '2024-02-06 11:25:48'),
(22, '7777', 'Producto de Prueba edit 2', 0.5, 52, 'producto solamente de prueba', 2, 54, 22, '2024-02-06 23:18:15', '2024-02-06 23:20:53'),
(23, '8888', 'Producto de Prueba', 0.2, 52, 'producto solamente de prueba', 2, 54, 22, '2024-02-22 15:45:57', '2024-02-22 15:46:42'),
(24, '999', 'Producto de Prueba 999', 0.5, 52, 'producto solamente de prueba 999', 2, 54, 22, '2024-02-23 00:52:42', '2024-02-23 00:52:42'),
(25, '9999', 'Producto Genial', 2.5, 28, 'Falto kilos extra', 21, 13, 10, '2024-02-23 01:04:32', '2024-02-23 01:04:32');
...
(34, 'un titulo random', 'descripción random 1', '2024-02-05 15:21:11', '2024-02-05 15:23:51'),
(35, 'un titulo random 2', 'descripción random 2', '2024-02-05 15:22:13', '2024-02-05 15:22:13');
...
INSERT INTO `turn` (`id`, `name`, `start_time`, `end_time`, `created_at`, `updated_at`) VALUES
(1, 'Turno Mañana', '07:30:00', '12:30:00', '2024-02-06 11:12:21', '2024-02-06 11:12:21'),
(2, 'Turno Tarde', '02:00:00', '19:00:00', '2024-02-06 11:12:21', '2024-02-06 11:12:21'),
(3, 'Turno Noche', '19:00:00', '02:00:00', '2024-02-06 11:12:49', '2024-02-06 11:12:49'),
(4, 'Horario de supervisión', '09:30:00', '11:30:00', '2024-02-06 11:41:18', '2024-02-09 00:46:34'),
(5, 'Despacho Diurno', '06:30:00', '07:30:00', '2024-02-09 00:47:14', '2024-02-09 00:47:14');
...
ALTER TABLE `occupation`
  ADD PRIMARY KEY (`id`),
  ADD KEY `OCCUPATION_TURN_FK` (`id_turn`);
...
ALTER TABLE `operator`
  ADD PRIMARY KEY (`id`),
  ADD KEY `OPERATOR_OCCUPATION_FK` (`id_occupation`);
...
ALTER TABLE `product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `PRODUCT_AREA_FK` (`id_area`),
  ADD KEY `PRODUCT_COLOR_FK` (`id_color`),
  ADD KEY `PRODUCT_TITLE_FK` (`id_title`);
...
--
-- Filtros para la tabla `occupation`
--
ALTER TABLE `occupation`
  ADD CONSTRAINT `OCCUPATION_TURN_FK` FOREIGN KEY (`id_turn`) REFERENCES `turn` (`id`);

--
-- Filtros para la tabla `operator`
--
ALTER TABLE `operator`
  ADD CONSTRAINT `OPERATOR_OCCUPATION_FK` FOREIGN KEY (`id_occupation`) REFERENCES `occupation` (`id`);

--
-- Filtros para la tabla `product`
--
ALTER TABLE `product`
  ADD CONSTRAINT `PRODUCT_AREA_FK` FOREIGN KEY (`id_area`) REFERENCES `area` (`id`),
  ADD CONSTRAINT `PRODUCT_COLOR_FK` FOREIGN KEY (`id_color`) REFERENCES `color` (`id`),
  ADD CONSTRAINT `PRODUCT_TITLE_FK` FOREIGN KEY (`id_title`) REFERENCES `title` (`id`);
COMMIT;
